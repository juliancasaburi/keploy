...
func DecodeConnectionDataMessage(Packets [][]byte) (models.OracleHeader, interface{}, bool, models.DataPacketType, error) {
	var packetData []byte
	...
	requestMessage := models.OracleDataMessage{
		DATA_OFFSET:       10,
		DATA_MESSAGE_TYPE: models.OracleConnectionDataMessageType,
		DATA_MESSAGE:      oracleConnectionDataMessage,
	}
